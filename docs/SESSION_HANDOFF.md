...
| CI | `.github/workflows/ci.yml` — database migrations/invariants + backend lint/test + production Docker smoke + Flutter analyze/test. PR #21 и повторный run на `main` зелёные. |
